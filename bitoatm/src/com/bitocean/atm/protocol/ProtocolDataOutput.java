...
public class ProtocolDataOutput {
	...
	public static JSONObject loginAdmin(String admin_id, String admin_password) throws JSONException {
		try {
	...
	public static JSONObject loginUser(String user_id, String user_password) throws JSONException {
		try {
			JSONObject output = new JSONObject();

...
public final class CashTradeScanQrActivity extends Activity implements SurfaceHolder.Callback {
    private static final String LOG_TAG = "CashTradeScanQrActivity";
    ...
    public void onCreate(final Bundle savedInstanceState) {
		...
		btn_cancel.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				CashTradeScanQrActivity.this.startActivity(new Intent(CashTradeScanQrActivity.this, TradeModeActivity.class));
			}

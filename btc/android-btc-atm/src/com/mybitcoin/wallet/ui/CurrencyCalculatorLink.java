...
import com.mybitcoin.wallet.ui.CurrencyAmountView.Listener;
...
public final class CurrencyCalculatorLink
{
    ...
    public void setCoinAmount(@Nonnull final BigInteger amount)
    {
        final Listener listener = this.listener;
        this.listener = null;

        localAmountView.setAmount(amount, true);

...
import com.mybitcoin.wallet.camera.CameraManager;
...
//				finish();
				ScanActivity.this.startActivity(new Intent(ScanActivity.this, TradeModeActivity.class));

			}
			
		});
        WalletActivityTimeoutController.getInstance().start(this);
        log.info("ActivityTimeoutController.getInstance.start is called in onResume");        
	}
...
//        timerFlag = false;
        ...
        log.info("ActivityTimeoutController.getInstance.end is called in onPause");	
	}
	...
	private Bitmap convertBmp=null;
	...
	public void handleResult(final Result scanResult, final Bitmap thumbnailImage, final float thumbnailScaleFactor)
	{
		...
		if (points != null && points.length > 0)
		{
		 ...
		 int w = thumbnailImage.getWidth();  
	        int h = thumbnailImage.getHeight();  
	      ...
	      convertBmp = Bitmap.createBitmap(thumbnailImage, 0, 0, w, h, matrix, true);  
		
	      scannerView.drawResultBitmap(convertBmp);
        ...
        public void handleMessage(Message msg){
            ...
            switch(msg.what){
                case msgKey1:
                    ...
                    if((sysTime - beginTime) > 240000)
                        startActivity(new Intent(ScanActivity.this,ExchangeRatesActivity.class));

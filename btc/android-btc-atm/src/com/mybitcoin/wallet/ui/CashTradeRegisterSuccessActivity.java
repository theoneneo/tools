...
public class CashTradeRegisterSuccessActivity extends WalletActivityTimeoutBase {
    private static final String LOG_TAG = "CashTradeRegisterSuccessActivity";
    ...
    protected void onCreate(final Bundle saveInstanceState) {
        ...
        setLayout(R.layout.cash_trade_kyc_register_success);
...
//        tradeType.setText(getUiInfo().getTextByName(UiInfo.COMMON_TRADETYPE_CASH));
        ...
        TextView success_title = (TextView) findViewById(R.id.cashtrade_kycregresult_success_title);
        TextView waiting_title = (TextView) findViewById(R.id.cashtrade_kycregresult_waiting_title);
        success_title.setText("Registeration Success! ");
        waiting_title.setText("Please waiting for Verification!");

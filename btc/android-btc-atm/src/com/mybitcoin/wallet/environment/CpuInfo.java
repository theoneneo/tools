...
public final class CpuInfo {
     ...
     */
    public static float getSystemCpuUsage(@Nonnull String start, @Nonnull String end) {
     ...
     */
    public static long getSystemUptime(@Nonnull String[] stat) {
        /*
     ...
     * @param stat see {@link #readSystemStat()}
     */
    public static long getSystemIdleTime(@Nonnull String[] stat) {
        try {
     ...
     */
    public static float getProcessCpuUsage(@Nonnull String start, @Nonnull String end, long uptime) {
     ...
     */
    public static long getProcessUptime(@Nonnull String[] stat) {
     ...
     * @param stat obtained with {@link #readProcessStat(int)}
     */
    public static long getProcessIdleTime(@Nonnull String[] stat) {
    ...
    /**
     * Return the CPU usage of current process, in percent.
     * <p>
     * The call is blocking for the time specified by elapse.
     * </p>
     *
     ...
     * available.
     */
    public static float syncGetCurrentProcessCpuUsage(long elapse) {
        return syncGetProcessCpuUsage(Process.myPid(), elapse);
    }
}

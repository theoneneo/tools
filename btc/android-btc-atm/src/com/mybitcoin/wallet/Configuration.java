...
public class Configuration
{
    ...
    public static final String CRYPTO_PRIVATE_KEY = "crypto_private_key";
    ...
    public void setCryptoPrivateKey(String cryptoPrivateKey){
        prefs.edit().putString(CRYPTO_PRIVATE_KEY,cryptoPrivateKey).commit();
    }
    public String getCryptoPrivateKey(){
        return prefs.getString(CRYPTO_PRIVATE_KEY,"");
    }
